...
if __name__ == '__main__':
    ...
    coupling_map = arquin.converters.edges_to_coupling_map(device.fine_edges)
    ...
    # compiler = arquin.ModularCompiler(circuit=circuit,circuit_name='regular',device=device,device_name='ring')
    # compiler.run()
